...
const Cart = () => {
  ...
  const placeOrderHandler = () => {
    ...
    if (selectedAddress) {
      setOrderPlaced(true);
      dispatch(clearCartAsync(itemsId));
    } else {
            ...
            <div className="card p-5 m-5">
              <div className="card-body text-center ">
                <div className="border p-3 rounded">
                  <FaCheckCircle className="fs-1 text-success my-4" />
                  <h1 className="text-success">Order Confirmed</h1>
                  <p className="lead">
                    Your order is confirmed. You will recieve an order
                    ...
                    <div className="col-md-3  ">
                      ...
                      <div>
                        <button
                          ...
                          className="primary-btn fw-medium text-light w-100 py-2 rounded"
                        >
                          PLACE ORDER
                        </button>
                      </div>
